...
public class EditDistanceControllerTest {
    ...
    @InjectMocks
    private EditDistanceController editDistanceController;
    ...
    public void testGetEditDistanceWithMissingParameter() {
        ...
        when(editDistanceService.findEditDistance(word1, word2)).thenThrow(new IllegalArgumentException("Missing parameter"));

        assertThrows(IllegalArgumentException.class, () -> editDistanceController.getEditDistance(word1, word2));
    }    
}
