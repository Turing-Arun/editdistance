...
/**
 * Service class for calculating the minimum edit distance between two words.
 ...
 *
 * <p>This class uses dynamic programming to compute the edit distance efficiently.</p>
 *
 * <p>Example usage:</p>
 * <pre>
 * {@code
